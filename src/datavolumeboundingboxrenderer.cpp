...
{
    if (!shaderProgram.addShaderFromSourceFile(QOpenGLShader::Vertex, SHADER_DIR + QString(
                                               "lines_vshader.glsl")))
    {
    ...
    if (!shaderProgram.addShaderFromSourceFile(QOpenGLShader::Fragment, SHADER_DIR + QString(
                                               "lines_fshader.glsl")))
    {
